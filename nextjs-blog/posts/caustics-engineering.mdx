...
![Clear Acrylic](/images/caustics-engineering/window_clear.jpg)

But it has the magic property that if you shine a flashlight on it, it forms an image:

![2D Image of Cat](/images/caustics-engineering/2D_image.jpg)

And if you take it out in the sun, it produces this 3D hologram:

![Cat Video](/images/caustics-engineering/3dcat.mp4)
...
![Example Caustic](/images/caustics-engineering/glass_caustic_pd.jpg)
<Attribution src="https://pixabay.com/photos/glass-water-kaleidoscope-1730518/" srcName="Pixabay" license="https://pixabay.com/service/license/" licenseName="public domain">Photo from SRC, licensed as LICENSE</Attribution>
...
![Water Caustics](/images/caustics-engineering/water_caustics_cc.jpg)
<Attribution src="https://www.flickr.com/photos/fdecomite/244887979" srcName="fdecomite" license="https://creativecommons.org/licenses/by/2.0/" licenseName="CC-BY">Photo from SRC, licensed as LICENSE</Attribution>
...
![Parabolic Lens](/images/caustics-engineering/traditional_lens_2.svg)
...
1. The overall thickness of the lens does not have a direct impact on the outgoing ray angle. We could add material to the left side of this lens and nothing would change. The first transition, from air to glass, can be entirely ignored.
2. The angle between the incoming light rays and the glass-air boundary has a strong effect on the refracted ray angle.
3. Whether two rays converge or diverge is controlled by how *curved* the lens is where the glass meets the air
...
![Slight Refraction](/images/caustics-engineering/slight_refraction.jpg)
...
![Diagram](/images/caustics-engineering/diagram.png)
...
![Diagram 2](/images/caustics-engineering/diagram2.png)
...
```
![Image and Loss Function](/images/caustics-engineering/image_and_loss.jpg)
...
![Gradient of L as a vector field](/images/caustics-engineering/grad_L.jpg)
...
![Phi](/images/caustics-engineering/example_phi.jpg)

Here is an example $\Phi$. It is just some scalar field best viewed as a heightmap.

![Gradient of Phi](/images/caustics-engineering/example_grad_phi.jpg)
...
![Phi](/images/caustics-engineering/clearly_cat_phi.jpg)
...
![Negative Gradient of Phi](/images/caustics-engineering/negative_grad_phi.jpg)
...
![Image and Vector Field](/images/caustics-engineering/side_by_side.jpg)
...
![Grid After Warping](/images/caustics-engineering/side_by_side_warped.jpg)
...
![Screenshot of Fusion360](/images/caustics-engineering/Fusion360.jpg)

The reason it is darker in some areas is because the mesh is more tightly packed in those areas. Let's zoom in on the eye:

![Zoom in on the Eye](/images/caustics-engineering/zoom_eye.jpg)
...
![Zoom in on the Pupil](/images/caustics-engineering/zoom_pupil.jpg)
...
![Overall Flow](/images/caustics-engineering/overall_flow.jpg)
...
![Snell's Law](/images/caustics-engineering/snells_law_2.svg)
...
![Example Surface Normals](/images/caustics-engineering/surface_normals.svg)
<Attribution src="https://en.wikipedia.org/wiki/Normal_(geometry)#/media/File:Normal_vectors_on_a_curved_surface.svg" srcName="Chetvorno" license="https://creativecommons.org/publicdomain/zero/1.0/deed.en" licenseName="CC0">Photo from SRC, licensed as LICENSE</Attribution>
...
![Final Object](/images/caustics-engineering/final_object_1.jpg)
...
![Final Object](/images/caustics-engineering/final_object_2.jpg)

The height differences are subtle but certainly enough to get the job done.

![Finished Product](/images/caustics-engineering/finished_product.jpg)
...
![Simulated Image](/images/caustics-engineering/blender.jpg)
...
![On the Router](/images/caustics-engineering/on_the_router.jpg)
...
![After Sanding](/images/caustics-engineering/after_sanding.jpg)
