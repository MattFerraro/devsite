...
Every magnet has a <span style={{color:"red"}}>North</span> pole and a <span style={{color:"blue"}}>South</span> pole which are inseparable so we call them Dipoles. The "strength" of a dipole is called $m$, its _magnetic dipole moment_.
...
At the same time, all three particles exhibit a quantum-mechanical property called **spin** which means they all behave like tiny gyroscopes that can never cease spinning. They always have angular momentum vectors pointing off in some direction so they resist changes in orientation just like gyroscopes.
