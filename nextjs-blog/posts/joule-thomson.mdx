...
teaser: 'A surprising quest to answer a remarkably simple question'
teaserImage: 'https://www.mattferraro.dev/images/joule-thomson/jt_preview_2.png'
date: '2021-12-16'
---
...
$$
\text{Internal Energy = Kinetic Energy + Potential Energy}
$$

While

$$
\text{Temperature} = k \cdot \text{Kinetic Energy}
$$
...
This not just a fun novelty, it is an important step in the [Linde Process](https://en.wikipedia.org/wiki/Liquefaction_of_gases) which is widely used for liquifying gasses.
...
Here we have finally arrived at the full picture. At most achievable pressures, every fluid actually has _two_ inversion temperatures! Between these temperatures, the fluid will cool. Beyond them, the fluid will heat up. But starting from ultra-high pressures, all fluids heat up.
...
You can find me on [twitter](https://twitter.com/mferraro89) or send me an email at mattferraro.dev@gmail.com.
